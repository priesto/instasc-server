...
--
-- Host: localhost    Database: insta_sc
-- ------------------------------------------------------
...
CREATE TABLE `accounts` (
  ...
  `uid` int(11) NOT NULL,
  UNIQUE KEY `aid` (`aid`),
  UNIQUE KEY `ig_username` (`ig_username`),
  KEY `uid` (`uid`),
...
CREATE TABLE `posts` (
  ...
  PRIMARY KEY (`pid`),
  KEY `fk_to_aid` (`aid`),
  CONSTRAINT `fk_to_aid` FOREIGN KEY (`aid`) REFERENCES `accounts` (`aid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-04-21 17:27:06
